...
def harommal_oszthato_szamok(szam):
    i = 3
    while i <= szam:
        if i == szam or i + 3 > szam:
            print(i, end='')
        else:
            print(i, end=', ')
        i += 3
...
while szam % 5 != 0:
    print("Ez a szám nem osztható 5-tel. Kérem próbálja újra.")
    szam = int(input("Kérem adjon meg egy 5-tel osztható számot: "))
